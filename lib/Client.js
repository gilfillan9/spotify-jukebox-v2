...
module.exports = function (socket) {
    ...
    socket.on('addTrack', (uri) => Spotify.getTrack(uri).then(Queue.addTrack));
    socket.on('addTracks', (uris) => Spotify.getTracks(uris).then(Queue.addTracks));
    socket.on('replaceTracks', (uris) => {
        Queue.clear(true);
        Spotify.getTracks(uris).then(Queue.addTracks);
    });
