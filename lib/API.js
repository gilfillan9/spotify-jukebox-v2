...
app.delete('/queue', requestWrapper(function (req, res) {
    Queue.clear();
}));
app.delete('/queue/:uuid', requestWrapper(function (req, res) {
...
app.get('/settings', requestWrapper(function (req, res) {
    return Promise.all([
...
app.get('/settings/accounts', requestWrapper(function (req, res) {
    return Spotify.listAccounts().then((accounts) => Object.values(accounts));
}));

app.post('/settings/accounts', requestWrapper(function (req, res) {
...
app.post('/settings/accounts/switch', requestWrapper(function (req, res) {
